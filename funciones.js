// --- FUNCIONES DE NAVEGACIÓN Y SONIDO ---
...
function jugar() {
    ...
    var sfxStart = new Audio('audio/sfxStart.mp3');
    sfxStart.play();
}
...
function siguientePersonaje() {
    ...
    var sfxclic = new Audio('audio/sfxClic.mp3');
    sfxclic.play();
}
...
function personaje2() {
    ...
    var sfxStart = new Audio('audio/sfxClic.mp3');
    sfxStart.play();
}
...
function comenzarJuego() {
    ...
    var sfxStart = new Audio('audio/comenzar.mp3');
    sfxStart.play();
}

// --- LÓGICA DEL JUEGO (ESCENARIO Y DISPAROS) ---
...
function cargarEscenario() {
    ...
    // --- CONTADOR DE MUERTES (CALAVERAS) ---
    // Limpiamos los contenedores antes de dibujar para evitar duplicados
    document.querySelector('.vidas1').innerHTML = "";
    document.querySelector('.vidas2').innerHTML = "";

    // Si Jugador 1 gana punto (marcador1), Jugador 2 tiene muerte (vidas2)
    for (let i = 0; i < marcador1; i++) {
        document.querySelector('.vidas2').innerHTML += "<img src='img/calavera.png'>";
    }
    // Si Jugador 2 gana punto (marcador2), Jugador 1 tiene muerte (vidas1)
    ...
    // --- CARGAR PERSONAJES SELECCIONADOS ---
...
function listos() {
    setTimeout(function() {
        document.querySelector('.msj').style.opacity = "0.5";
    }, 500);
}

function conteo() {
    var sfxclic = new Audio('audio/sfxTiempo.mp3');
